...
<main class="py-5">
    <section id="listado" class="mb-5">
        <div class="container">
            ...
            <form action="<?php echo FRONT_ROOT ?>Function/ShowDateRangeGenre" method="POST">
                <table>
                <tr>
                    <td>Start Date</td>
                    <td>Finish Date</td>
                ...
                <tr>
                    ...
                    <td><button type="submit" class="btn btn-primary" name='list' value='<?php echo $genre_select ?>'> Search </button></td>
                </tr>
